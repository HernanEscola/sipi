...
<br>
<h1 align=" center" class="titulo">Registro de Contratación </h1>
<html:form action="cContratacionTipoSeleccionarAction.do" method="POST">
<html:hidden property="accion"/>

<logic:equal property="accion" value="seleccionarTipo" name="cContratacionTipoSeleccionarActionForm">
<div class="tab-container"  id="container">
    <table align="center" cellpadding="0" cellspacing="0" width="600">
      <tr>
        <td>
          <ul class="tabs">
           <li><a href="#" onClick="return showPane('tipo', this)" id="tab1">Contratación</a></li>
          </ul>
        </td>
      </tr>
    </table>
