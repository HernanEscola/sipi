...
<html:form action="cMarcaBuscarAction.do" method="POST">


	<h1 align="center" class="titulo">Búsqueda de Marcas</h1>
						...
						<td class="CformAreaBotones">
							<div align="right">
								<jsp:include page="/jsp/layout/botones.jsp">
									<jsp:param name="formulario" value="cMarcaBuscarActionForm" />
				...
				<table align="center" width="100%">
					...
					<tr>
						<td colspan="10"><display:table style="width: 100%"
								...
								name="sessionScope.cMarcaBuscarActionForm.resultados"
								id="marcaListar" requestURI="cMarcaBuscarAction.do"
								decorator="conicet.apps.svt.web.marca.decorator.CMarcaDisplayWrapper">
