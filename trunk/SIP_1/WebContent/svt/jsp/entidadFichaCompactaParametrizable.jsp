...
<bean:define id="tipo" value='<%= request.getParameter("tipo")%>' />

<logic:equal value="nuevo" name="tipo">
<bean:define id="entidadFichaCompacta" name="form" property="entidadNuevo" />
</logic:equal>
<logic:equal value="original" name="tipo">
<bean:define id="entidadFichaCompacta" name="form" property="entidadOriginal" />
</logic:equal>



<bean:define id="tipoEntidad" name="entidadFichaCompacta" property="tipo" />
<logic:equal value="1" property="pais" name="entidadFichaCompacta">
  <bean:define id="provincia" name="entidadFichaCompacta" property="provincia" />
</logic:equal>
          ...
          <td>
            <table align="left">
              ...
              <tr>
                ...
                <td class="CformDato">
                  <bean:write name="entidadFichaCompacta" property="descripcion"/>
                </td>
              </tr>
          ...
          <td>
            <table align="left">
              ...
              <tr>
                ...
                <td class="CformDato">
                  <bean:write name="entidadFichaCompacta" property="descripcion"/>  -
                  <bean:write name="entidadFichaCompacta" property="nombre"/>
                </td>
              </tr>
              <tr>
