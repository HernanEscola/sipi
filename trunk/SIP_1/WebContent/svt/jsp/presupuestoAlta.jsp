...
<html:form action="cPresupuestoAltaAction.do" method="POST" enctype="multipart/form-data">
	<html:hidden property="accion"/>
	<html:hidden property="cambiaPanel"/>
	<logic:equal property="accion" value="alta"	name="cPresupuestoActionForm">
    <script>
      ...
      <div>
        <jsp:include page="/jsp/entidades/presupuesto.jsp">
          ...
          <jsp:param name="actionName" value="cPresupuestoAltaAction" />
        </jsp:include>
      </div>
    </div>
	</logic:equal>

	<logic:equal property="accion" value="altaCfm" name="cPresupuestoActionForm">
		<jsp:include page="/jsp/entidades/presupuesto.jsp">
