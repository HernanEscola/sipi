...
<logic:equal property="entidadTipo" value="persona" name="cEntidadDetalleActionForm">
       ...
       <table>
          ...
          <tr>
            ...
            <td class="CformDato">
            <bean:write name="cEntidadDetalleActionForm" property="documentoNro" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Cuit:</td>
            <td class="CformDato"><!--  <html:text property="cuit"/></td-->
          ...
          <tr>
            <td class="CformNombre">País:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="paisParticularDescripcion" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Provincia:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="provinciaParticularDescripcion" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Partido:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="partidoParticularDescripcion" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Localidad:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="localidadParticularDescripcion" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Código Postal:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="codigoPostal" /></td>
          </tr>
          <tr>
            <td class="CformNombre">E-Mail:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="mail" /></td>
          </tr>
          <tr>
            <td class="CformNombre">Teléfono:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="telefono" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="CformDato"><html:select disabled="true" property="categoria">
              <html:options collection="comboCategoria" property="value" labelProperty="label" />
            </html:select></td>
          </tr>
           <tr>
            <td class="CformNombre">Tema de Investigación:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="temaInvestigacionCarrera"  />
            </td>
          </tr>
           <tr>
            <td class="CformNombre">Formación Académica:</td>
            <td class="CformDato">
              <bean:write name="cEntidadDetalleActionForm" property="formacionAcademica"  />
            </td>
          </tr>
