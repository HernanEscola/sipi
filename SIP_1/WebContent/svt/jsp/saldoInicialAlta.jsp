...
function removeprestadorsubmit(){
	document.cSaldoInicialAltaActionForm.action = 'cSaldoInicialAltaAction.do?btnSubmit=removeprestadorsubmit';
	document.cSaldoInicialAltaActionForm.submit();
}

function recargaUvt(){
	document.cSaldoInicialAltaActionForm.action = 'cSaldoInicialAltaAction.do?btnSubmit=recargauvt';
	document.cSaldoInicialAltaActionForm.submit();
	}
...
<br>
<h1 align="center" class="titulo">Registro de Saldo Inicial</h1>

<html:form action="cSaldoInicialAltaAction.do" method="POST">
...
<html:hidden property="prestadorDescripcion"	styleId="prestadorDescripcion" />
  ...
  <logic:equal property="accion" value="alta" name="cSaldoInicialAltaActionForm">
  <script>
	...
	function validarImporteConDecimales(obj){
	   ...
	   if (obj.value.length==9 && (tecla!=46) && (obj.value.indexOf(".",0)==-1) )
        ...
        <jsp:include page="/jsp/entidades/saldoInicial.jsp">
         <jsp:param name="pageName" value="saldoInicialAlta" />
          <jsp:param name="tipoPantalla" value="input" />
          <jsp:param name="formulario" value="cSaldoInicialAltaActionForm" />
          <jsp:param name="actionName" value="cSaldoInicialAltaAction.do"/>
          <jsp:param name="displayLinks" value="si" />
        </jsp:include>
     
  </logic:equal> 

  <logic:equal property="accion" value="confirmar" name="cSaldoInicialAltaActionForm">
    <jsp:include page="/jsp/entidades/saldoInicial.jsp">
      <jsp:param name="pageName" value="saldoInicialAlta" />
