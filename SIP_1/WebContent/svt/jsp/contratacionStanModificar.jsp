...
setupPanes("container", document.cContratacionStanModificarActionForm.tab.value);
}

function irA(obj){
document.cContratacionStanModificarActionForm.tab.value=obj;
setupPanes("container", document.cContratacionStanModificarActionForm.tab.value);
}

function cambiarPanel(paneId, activeTab){
  document.cContratacionStanModificarActionForm.tab.value=activeTab.id;
  return showPane(paneId, activeTab);
}

</script>
<br>
<h1 align=" center" class="titulo">Modificación de Contrataci&oacute;n de Stan</h1>

<html:form action="cContratacionStanModificarAction.do" method="POST">
<html:hidden property="accion"/>
<html:hidden property="tab"/>

<logic:equal property="accion" value="modificar" name="cContratacionStanModificarActionForm">
  <div class="tab-container"  id="container">
    <table align="center" cellpadding="0" cellspacing="0" width="600">
      <tr>
        <td>
          <ul class="tabs">
           <li><a href="#" onClick="return cambiarPanel('contratacion', this)" id="tabContratacion">Stan</a></li>
    ...
    <div>
                      ...
                      <tr>
                        ...
                        <td class="CformDato">
                          <html:text property="contacto"  maxlength="80" size="50"/>
                           ...
                           <tr>
	                	<td class="CformNombre">Publicación Web:&nbsp;</td>
	         			<logic:equal value="S" property="publicable" name="cContratacionStanModificarActionForm">
							<td class="CformDato" >
			                   Sí <html:radio property="publica" value="S"  />
		        	           No <html:radio property="publica" value="N" />
		        	        </td>
						</logic:equal>
	        	  		<logic:equal value="N" property="publicable" name="cContratacionStanModificarActionForm">
							<td class="CformDato" >
      ...
      <table class="CformTable" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>
               ...
               <table align="center" width="100%">
                    <tr>
                      <td colspan="10">
                        <display:table name="sessionScope.cContratacionStanModificarActionForm.contratantes" decorator="conicet.apps.svt.web.contratante.decorator.CContratanteSeleccionarDisplayWrapper" style="width: 100%">
       ...
       <logic:equal name="cContratacionStanModificarActionForm" property="categoriaComun" value="N">
            <tr>
                  ...
                  <table align="center" width="100%">
                    <tr>
                      <td colspan="10"  width="100%">
                        <display:table name="sessionScope.cContratacionStanModificarActionForm.instrumentos" id="ofertasSeleccionadas" decorator="conicet.apps.svt.web.instrumento.decorator.COfertaSeleccionarDisplayWrapper" style="width: 100%">
...
<logic:equal property="accion" value="modificarCfm" name="cContratacionStanModificarActionForm">
  ...
  <tr>
    <td>
          ...
          <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td class="CformDato">
                  <bean:write name="cContratacionStanModificarActionForm" property="responsableTecnico"/>
                </td>
              </tr>
              <tr>
                <td class="CformNombre" width="130">Clasificación:&nbsp;</td>
                <td class="CformDato">
                  <bean:write name="cContratacionStanModificarActionForm" property="clasificacion"/>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="CformDato">
                  <bean:write name="cContratacionStanModificarActionForm" property="contacto"/>
                </td>
              </tr>
                 <tr>
	  ...
	  <logic:notEmpty property="distribucion" name="cContratacionStanModificarActionForm">

		      <table align="center" width="100%">
		        <tr>
		          <td colspan="10">
		            <display:table name="sessionScope.cContratacionStanModificarActionForm.distribucion" decorator="conicet.apps.svt.web.instrumento.decorator.CInstrumentoDistribucionDetalleDisplayWrapper" style="width: 100%">
	  ...
	  <logic:empty property="distribucion" name="cContratacionStanModificarActionForm">
	           <table width="100%">
	            <tr >
