...
<xsl:template match="precioOferta">
	...
	<fo:table space-before="0.3in" >
				...
				<fo:table-body>
					<fo:table-row  >
						   <fo:table-cell >
						   		<fo:block text-align="left" text-decoration="underline" font-family="Arial, Helvetica, sans-serif" font-size="8pt" font-weight="bold" >
									Distribución Oferta Tecnológica :<xsl:value-of select="descripcionPO"/>
								</fo:block>
						   </fo:table-cell>
					</fo:table-row>
				</fo:table-body>
	...
	<fo:table width="100%" table-layout="fixed"  border-width="thin">
				<fo:table-column column-number="1" column-width="500pt" />
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-weight="bold" font-size="8pt"   >

						<fo:table-row >
							<fo:table-cell text-align="left" padding-before="0.03in"  padding-start="0.03in" border-left="solid" border-right="solid" border-width="thin">
								<fo:block>
									Comisiones
								</fo:block>
							</fo:table-cell>
	...
	<fo:table width="100%" table-layout="fixed"  >
				...
				<!-- HEADER -->
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-size="8pt"   >
					<xsl:apply-templates select="comisionesPO"/>
				</fo:table-body>
	</fo:table>
	...
	<fo:table width="100%" table-layout="fixed" border="solid" border-width="thin" >
				...
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-size="8pt"   >
					<fo:table-row >
							...
							<fo:table-cell text-align="right" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-width="thin">
								<fo:block>
									<xsl:value-of select="totalComisionPO"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
				</fo:table-body>
	...
	<fo:table width="100%" table-layout="fixed" border="solid"  space-before="0.1in" border-width="thin">
				...
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-size="8pt"   >
						...
						<fo:table-row >
							...
							<fo:table-cell text-align="right" padding-before="0.03in" padding-start="0.03in" border-left="solid"  border-width="thin">
								<fo:block>
									<xsl:value-of select="recuperoDeFondosPO"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
	...
	<fo:table width="100%" table-layout="fixed" border="solid" space-before="0.1in">
				...
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-size="8pt"   >
						...
						<fo:table-row >
							...
							<fo:table-cell text-align="right" padding-before="0.03in" padding-start="0.03in" border-left="solid"  border-width="thin">
								<fo:block>
									<xsl:value-of select="saldoADistribuirPO"/>
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
				</fo:table-body>
	...
	<fo:table width="100%" table-layout="fixed"  >
				...
				<!-- HEADER -->
				<fo:table-body text-align="left" font-family="Arial, Helvetica, sans-serif" font-size="8pt"  >
					<xsl:apply-templates select="comisionesAdicionalesPO"/>
				</fo:table-body>
	</fo:table>
...
<!-- colección de contratantes-->
<xsl:template match="comisionesPO">
	<xsl:apply-templates select="comisionPO" />
</xsl:template>

<xsl:template match="comisionPO">
	<fo:table-row>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid"  border-width="thin">
			<fo:block>
				<xsl:value-of select="descripcionC"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid"  border-width="thin">
			<fo:block>
				<xsl:value-of select="convenioMarcoC"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid"  border-width="thin">
			<fo:block>
				<xsl:value-of select="porcentajeC"/>
			</fo:block>
		</fo:table-cell>
...
<!-- colección de contratantes-->
<xsl:template match="comisionesAdicionalesPO">
	<xsl:apply-templates select="comisionAdicionalPO" />
</xsl:template>

<xsl:template match="comisionAdicionalPO">
	<fo:table-row>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid" border-bottom="solid" border-width="thin">
			<fo:block>
				<xsl:value-of select="descripcionCA"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid" border-bottom="solid" border-width="thin">
			<fo:block>
				<xsl:value-of select="convenioMarcoCA"/>
			</fo:block>
		</fo:table-cell>
		<fo:table-cell text-align="left" padding-before="0.03in" padding-start="0.03in" border-left="solid" border-top="solid" border-bottom="solid" border-width="thin">
			<fo:block>
				<xsl:value-of select="porcentajeCA"/>
			</fo:block>
		</fo:table-cell>
