...
public class CAutoCompleteContratanteOtro extends CAutoComplete {

	CContratanteBusquedaStruct contratanteBuscar;
	...
	protected Collection find(HttpServletRequest request) throws CException{
		...
		return new ArrayList<CContratante>(CContratanteService.findContratanteOtroByCriterio(contratanteBuscar));
	}
	...
	public CAutoCompleteContratanteOtro(CContratanteBusquedaStruct contratanteBuscar) {
		this.contratanteBuscar = contratanteBuscar;
	}

	public CAutoCompleteContratanteOtro(){
